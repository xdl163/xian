from .settings import (config_path,dir_path,IMAGE_SIZE,RTSP_RECONNECT_INTERVAL,HTTP_RECONNECT_INTERVAL,
                       ...
                       label_video_id,show_id,point_max_size,model_size,model_threshold,model_path,video_list,video_thread,window,passwd,license_data,recognition_fps,fetch_sleep_idle,fetch_sleep_full,get_frame_interval,refresh_timing_by_fps,set_recognition_fps)
